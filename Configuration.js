...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Contador de Personas", endpointType.peopleCounter);
  var gfs = endpoints.addEndpoint("5", "Parking", endpointType.genericSensor);
  gfs.variableTypeId = 1362;
